...
alan = Sitter.create(name: "Alan L. Cinsavich", hourly_rate: 15, location: "Columbia, MD")
adam = Sitter.create(name: "Adam Johnson", hourly_rate: 26, location: "NYC")
teresa = Sitter.create(name: "Teresa Nguyen", hourly_rate: 35, location: "Bellaire, TX")
